...
class _LiteratureReviewScreenState extends State<LiteratureReviewScreen> {
  ...
  final List<Map<String, dynamic>> _sources = [
    {
      'tag': 'CORE',
      'tagColor': AppTheme.friendlyPurple,
      'tagBg': AppTheme.friendlyPurpleSoft,
      'title': 'Chen & Liu, 2024',
      'subtitle':
          'A Probabilistic Framework for Quantum-Classical Feature Entanglement',
    },
    {
      'tag': 'CITED',
      'tagColor': AppTheme.actionBlue,
      'tagBg': AppTheme.accentBlueSoft,
      'title': 'Patel et al., 2023',
      'subtitle': 'Reproducible Benchmarks for Hybrid QV-CNN Architectures',
    },
    {
      'tag': 'CITED',
      'tagColor': AppTheme.actionBlue,
      'tagBg': AppTheme.accentBlueSoft,
      'title': 'Watanabe et al., 2022',
      'subtitle': 'Decoherence-Aware Loss Landscapes for Noisy Quantum Devices',
    },
  ];
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFFFFF8EE), Color(0xFFFFF1E0)],
        ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Output finalized — saved to your Literature library.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10.h),
          Text(
            'Three independent studies converge on the conclusion that hybrid quantum-classical architectures outperform pure Transformer baselines on high-frequency time-series forecasting, while disagreeing on the scaling regime where advantages emerge.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10.h),
          Text(
            'Across three benchmark datasets (NASDAQ HFT, weather radar, genomic streams), hybrid architectures sustain a 40% training overhead reduction and 18% inference latency improvement, with decoherence effects dominating above 32 qubits.',
            style: theme.textTheme.bodyMedium?.copyWith(
              color: AppTheme.primaryNavy.withOpacity(0.85),
              height: 1.5,
            ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    '"The hybrid architecture reduces training overhead by 40% while improving predictive accuracy."',
                    style: theme.textTheme.bodySmall?.copyWith(
  ...
  Widget _actionButton(ThemeData theme, IconData icon, String label) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, color: AppTheme.primaryNavy, size: 18.sp),
          SizedBox(width: 6.w),
          Text(
            label,
            style: TextStyle(
            ...
            child: Row(
              children: [
                _chip(
                  theme,
                  'Explain jargon',
                  () => _sendMessage(chipText: 'Explain jargon'),
                ),
                _chip(
                  theme,
                  'Find counter-evidence',
                  () => _sendMessage(chipText: 'Find counter-evidence'),
                ),
                _chip(
                  theme,
                  'Suggest follow-ups',
                  () => _sendMessage(chipText: 'Suggest follow-ups'),
                ),
              ],
            ),
          ),
